...
//     return res.status(200).send({ status: 1, message: "Values added successfully" });
//   } catch (error) {
...
//       { _id: req.user._id },
//       { likeditems: likes, dislikeditems: dislikes },{new: true}
//     );

//     return res.status(200).send({ status:1, message: "Values updated successfully", data:{likeditems: likes, dislikeditems: dislikes}});
//   } catch (error) {
//     return res.status(400).send({ status:0, message: "Some Error Occur" });
//   }
// };
...
//       { _id: user_id },
//       { ispregnant: ispregnant, isbreastfeeding: isbreastfeeding, token:token },
//       {new:true}
//     );

//     return res.status(200).send({ status:1, message: "Values added successfully", data: result });
//   } catch (error) {
//     return res.status(400).send({ status:0, message: "Some Error Occur" });
//   }
// };
...
//   { new: true }
// );
// res.status(200).send({ status:1, message: "Preferences updated successfully", data: {likeditems: liked[0],dislikeditems: list[0]} });
// }
//   }
